...
const SearchInput = ({ handleSearchClick }: PropsType) => {
      ...
      <div className={styles.SearchResults}>
        {chosenType === 'All' &&
          multiSearchData?.results.map((i) => (
            <>
              {i.media_type === 'movie' && (
                <Link to={`/title/movie/${i.id}`} onClick={handleSearchClick}>
              ...
              {i.media_type === 'tv' && (
                <Link to={`/title/tvSeries/${i.id}`} onClick={handleSearchClick}>
                  <div className="flex justify-center mt-5">
                    <img src={tmdbApiConfig.w500Image(i.poster_path)} />
                  </div>
                  <h2 className="font-semibold text-base text-slate-200 mt-3 text-center px-2 h-20">
              ...
              {i.media_type === 'person' && (
                <div className={styles.Person} onClick={handleSearchClick}>
        ...
        {chosenType === 'Movies' &&
          movieSearchData?.results.map((i) => (
            <Link to={`/title/movie/${i.id}`} onClick={handleSearchClick}>
              ...
              <div className={styles.Rating}>
                <AiFillStar />
                <div className="font-semibold text-base mx-2 text-slate-200">{i.vote_average}</div>
                <div className="relative">
